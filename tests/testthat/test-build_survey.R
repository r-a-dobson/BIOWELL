...
test_that("Works if error if online ", {
  expect_error(build_survey(
    survey_title = "Insert survey title here",
    sidepanel_message = "Insert sidepanel message here.",
    start_message = "Insert start message here",
    screen_message = "Insert screen message here",
...
test_that("Works if error if incorrent end response type length ", {
  expect_error(build_survey(
    survey_title = "Insert survey title here",
    sidepanel_message = "Insert sidepanel message here.",
    start_message = "Insert start message here",
...
test_that("Works if error if incorrent start response type length ", {
  expect_error(build_survey(
    survey_title = "Insert survey title here",
    sidepanel_message = "Insert sidepanel message here.",
    start_message = "Insert start message here",
...
test_that("Error if wrong length response options start ", {
  expect_error(build_survey(
    survey_title = "Insert survey title here",
    sidepanel_message = "Insert sidepanel message here.",
    start_message = "Insert start message here",
...
test_that("Error if wrong length response options end ", {
  expect_error(build_survey(
    survey_title = "Insert survey title here",
    sidepanel_message = "Insert sidepanel message here.",
    start_message = "Insert start message here",
...
test_that("Error if wrong length response options screen ", {
  expect_error(build_survey(
    survey_title = "Insert survey title here",
    sidepanel_message = "Insert sidepanel message here.",
    start_message = "Insert start message here",
    screen_message = "Insert screen message here",
    screen_questions = c("Insert participant screening question here","SW2"),
    screen_questions_ID = c("Screening_Q1","SW2"),
    screen_response_options = list(c(
      "You will be removed:SCREEN",
      "You will not be removed"
    )),
...
test_that("Error if wrong length response options screen ", {
  expect_error(build_survey(
    ...
    user_report = TRUE,
    offline_mode = TRUE,
    language = "incorrectlanguagechoice",
    return = "ui"
  ))
})
