...
![Create Dropbox account](https://raw.githubusercontent.com/r-a-dobson/BIO-WELL/main/man/V1/V1_0.png){width=75%}
...
![Authenticate Dropbox access token](https://raw.githubusercontent.com/r-a-dobson/BIO-WELL/main/man/V1/V1_5.png){width=75%}
