...
![Add redirect URI](https://raw.githubusercontent.com/r-a-dobson/BIO-WELL/main/man/Vignette1/Vignette1_2.png){width=75%}

Then, go to the Permissions tab and tick the relevant boxes. You need to give
the app permission to read and write files.

![Add Dropbox App permissions](https://raw.githubusercontent.com/r-a-dobson/BIO-WELL/main/man/Vignette1/Vignette1_3.png){width=75%}
...
[Get Dropbox name, key and secret](https://raw.githubusercontent.com/r-a-dobson/BIO-WELL/main/man/Vignette1/Vignette1_4.png){width=75%}
