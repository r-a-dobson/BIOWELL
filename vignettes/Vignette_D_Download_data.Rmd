...
In this vignette, you will now have downloaded your BIO-WELL survey response data into a single data frame. The next Vignette (E) will demsontrate `BIOWELL` package functions available for evaluating and analysing these data. 
