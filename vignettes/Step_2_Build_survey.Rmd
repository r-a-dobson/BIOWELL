...
end_response_options = list(c("Being able to smell (for example, no sense of smell, having a cold or hay fever)", "Hearing (answer assuming you are wearing hearing aides if you need them)", "Sight (answer assuming you are wearing glasses or contact lenses if you need them)"))
