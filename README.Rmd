...
For more details, see the package manual [here](https://github.com/r-a-dobson/dynamicSDM/blob/main/man/manual/BIOWELL_1.0.pdf) for more details on each function. 
